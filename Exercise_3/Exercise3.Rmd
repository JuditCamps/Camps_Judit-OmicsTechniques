...
# Results
As we can see from the boxplot of the raw data, we may have guessed that this data was already normalized, but as we could see in the principal components analysis, we obtain an incorrect plot.
